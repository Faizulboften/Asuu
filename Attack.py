...
def banner():
    os.system('clear')
    print " "
    print(" Berdoa Sebelum Menggunakan ")
  
    time.sleep(1.5)
    print GL+"┏━┓┏━┓╋╋╋╋┏┓" 
    print GL+"┃┃┗┛┃┃╋╋╋╋┃┃    versi 5,8"
    print GL+"┃┏┓┏┓┣━━┳━┛┃    region Indonesia"
    print GL+"┃┃┃┃┃┃┏┓┃┏┓┃"
    print GL+"┃┃┃┃┃┃┗┛┃┗┛┃"
    print GL+"┗┛┗┛┗┻━━┻━━┛"
    print GL+"--------------------------------" 
    print GG+"  📌Facebook DarkTeam "
    print GG+"  📌Mode In Indonesia "
    print GG+"  📌Gunakan Dengan Bijak "
    print GL+"--------------------------------"
    print GG+" Author : Faizul"
    print GG+" Facebook : Faizul"
    print GG+" Whastapp : 082216912936"
    print GL+"-------------------------------"
    print GL+"-------------------------------"
    print R+"   Facebook Sosial Mod"
    print GL+"--------------------------------"

banner()

print wd+"   https://www.github.com/Faizulboften"
print GG+"╭────\033[91m[\033[96m Faizul --->>\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92m╰────➲\033[93m  "))
print " "
print "\033[92m╭────\033[91m[ \033[96mBlack Whale File Wordlist \033[95m( Buatlah Wordlits Sendiri) \033[91;1m]"
...
print ("Founder-Anirban Sumon, DarkTeam, Chairman-Black Shadow")
raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
